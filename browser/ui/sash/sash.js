...
/* This file require a heavy refactor, is only here for temporary ui */
...
export interface ISashOptions {
	...
	/* A ref to another sash, perpendicular to this one, which
...
export class Sash extends Disposable {
	...
	/* The state of a sash defines whether it can be interacted w by the user
	...
	/* Forcefully stop any user interactions w this sash.
